...
class TrafficCarProcess(DataProcess):
    def __post_init__(self) -> None:
        ...
        self.traffic_json["sheet_name"] = "traffic_car"
        ...
        self.traffic_json["column"]["lane_id"] = []
        ...
        self.traffic_json["column"]["lOffset"] = []
        self.traffic_json["column"]["ttc_euclidean_distance"] = []
        self.traffic_json["column"]["thw_euclidean_distance"] = []
        ...
        try:
            ...
            if event["channel"] == self.traffic_json["topic"]:
                ...
                for fellow in msg.cars:
                    ...
                    self.traffic_json["column"]["lane_id"].append(fellow.tx_lane_id)
                    ...
                    self.traffic_json["column"]["lOffset"].append(fellow.lOffset)
